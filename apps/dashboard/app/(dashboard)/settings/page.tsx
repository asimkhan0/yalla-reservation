                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Click the image to upload. JPG, PNG or GIF up to
                                                5MB.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            {...form.register('location.googleMapsUrl')}
                            ...
                            <CardContent className="space-y-4">
                                {DAYS.map((day) => (
                                    <div key={day} className="flex items-center gap-4">
                                        <div className="w-24 font-medium capitalize text-sm">
                                            {day}
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Input
                    ...
                    <TabsContent value="ai" className="space-y-6 mt-0">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure how your WhatsApp bot behaves
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        This context is injected into the AI to help it answer
                                        specific questions.
                                    </p>
                                </div>
                            </CardContent>
